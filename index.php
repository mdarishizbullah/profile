...
<head>
  ...
  <title>HaizPro</title>
  <meta content="profile company of haizpro indonesia" name="description">
  <meta content="pembuatan website sukabumi" name="keywords">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">HaizPro</a></h1>
      ...
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="d-flex justify-content-center justify-content-lg-start">
            ...
            <a href="https://www.youtube.com/watch?v=t9_PAV00GwI&feature=youtu.be" class="glightbox btn-watch-video"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
          </div>
        </div>
  ...
  <main id="main" style="display: none;">
    ...
    <!-- ======= Pricing Section ======= -->
    <section id="pricing" class="pricing" style="display: block;">
      <div class="container" data-aos="fade-up">
    ...
    <section id="faq" class="faq section-bg" style="display: block;">
      <div class="container" data-aos="fade-up">
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <p>Get to know us more by following our social media accounts</p>
            <div class="social-links mt-3">
              <a href="https://twitter.com/MDarisHizbullah" class="twitter"><i class="bx bxl-twitter"></i></a>
              <a href="https://web.facebook.com/muhamaddaris.hizbullah" class="facebook"><i class="bx bxl-facebook"></i></a>
              <a href="https://www.instagram.com/mdarishizbullah/" class="instagram"><i class="bx bxl-instagram"></i></a>
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>HaizPro</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
